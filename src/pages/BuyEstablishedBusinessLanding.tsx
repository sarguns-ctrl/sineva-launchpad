...
import laundromatBusinessImage from "@/assets/laundromat-business-interior.jpg";
    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-2">
                  <img src={laundromatBusinessImage} alt="Laundromat business with washing machines" className="w-full h-56 object-cover" />
      ...
      <section id="lead-form-section" className="py-20 bg-gradient-to-br from-[#1e3a5f] via-[#2c5282] to-[#1a202c] relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <img src={laundromatBusinessImage} alt="" className="w-full h-full object-cover" />
        </div>
        <div className="container mx-auto px-4 relative z-10">
