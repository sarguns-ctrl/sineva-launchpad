-- Add more sample properties and businesses
...
('Orlando Metro', '2024 Q4', 'Inventory Analysis', 'Local MLS', 'Single-family home inventory remains tight.', '{"months_supply": 2.1, "new_listings": 1250, "pending_sales": 2100}'),
('Tampa Bay', '2024 Q4', 'Commercial Trends', 'Commercial Board', 'Office space demand recovering with 12% increase.', '{"vacancy_rate": 18.5, "lease_rate_psf": 28.50, "absorption": 125000}');

-- Create sample agent data for the Find Agents page (without auth.users dependency)
-- First, let's create some departments if they don't exist
INSERT INTO departments (name, description) VALUES 
('Sales', 'Real Estate Sales Department') 
ON CONFLICT (name) DO NOTHING;

-- Add some business categories for the business marketplace
INSERT INTO business_categories (name, description) VALUES 
('Food & Beverage', 'Restaurants, cafes, and food service businesses'),
('Technology', 'Software, IT services, and tech startups'),
('Retail', 'Stores, boutiques, and retail operations'),
('Fitness & Health', 'Gyms, wellness centers, and health services'),
('Automotive', 'Auto repair, dealerships, and automotive services')
ON CONFLICT (name) DO NOTHING;